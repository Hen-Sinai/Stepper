package component.executionResult.passive.flowResult;
...
public class ExecutedFlowDataPassiveController {
    ...
    public void init(ExecutionHistoryController2 executedFlowData) {
    ...
    private void showExecutedFlowData() {
        String finalUrl = HttpUrl
                ...
                .addQueryParameter("flowId",
                        parentController.getHistoryExecutionResultComponentController().getChosenFlowIdProperty().getValue())
                .build()
                .toString();
